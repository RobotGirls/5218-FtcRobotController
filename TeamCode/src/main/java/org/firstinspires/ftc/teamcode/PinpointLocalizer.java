...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1620.7346939698323; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1887.2716550335213; // x position of the perpendicular encoder (in tick units)
    }
