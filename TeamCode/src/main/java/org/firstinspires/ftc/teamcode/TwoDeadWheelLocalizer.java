...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1994.3628928142116; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 101.31790291923825; // x position of the perpendicular encoder (in tick units)
    }
