...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2025.7809285239343; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 459.40826022396516; // x position of the perpendicular encoder (in tick units)
    }
