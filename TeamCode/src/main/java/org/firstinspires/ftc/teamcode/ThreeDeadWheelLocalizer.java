...
public final class ThreeDeadWheelLocalizer implements Localizer {
    ...
    private Pose2d pose;
  // > Failed to transform dashboard-0.4.17.aar (com.acmerobotics.dashboard:dashboard:0.4.17) to match attributes {artifactType=enumerated-runtime-classes, org.gradle.category=library, org.gradle.libraryelements=jar, org.gradle.status=release, org.gradle.usage=java-runtime}.

    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
        // TODO: make sure your config has **motors** with these names (or change them)
        //   the encoders should xabe plugged into the slot matching the named motor
